    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-bg dark:bg-bg-dark transition-colors duration-200 font-sans">
      <div className="w-full max-w-sm space-y-8 animate-fade-in">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-bold text-text-DEFAULT dark:text-text-dark tracking-tight">Welcome back</h2>
          ...
          <div className="space-y-1">
            ...
            />
             <div className="flex justify-end">
                <button type="button" className="text-xs text-text-muted hover:text-primary transition-colors">Forgot password?</button>
             </div>
          </div>
        ...
        <Button variant="outline" className="w-full relative" onClick={handleGoogleLogin} isLoading={isLoading}>
